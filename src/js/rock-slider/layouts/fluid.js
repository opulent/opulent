...
(function() {
  (function($, window, document) {
    "use strict";
    $.fn.rockSlider.fluidLayout = function() {
      this.init = function() {
        this.element.addClass('rock-slider-fluid');
      };
      this.setup = function() {
        if (this.cache == null) {
          return;
        ...
        if (this.parent_height > this.element_height) {
          ...
          this.element_width = this.element_height / this.settings.height * this.settings.width;
          this.inner.height(this.element_height);
          this.inner.width(this.element_width);
        } else {
          this.element_width = this.parent_width;
          this.element_height = this.element_width / this.settings.width * this.settings.height;
          this.inner.height(this.element_height);
          this.inner.width(this.element_width);
        }
        this.slides.each((function(_this) {
          return function(i, element) {
            var $background, $layers, $slide, $video, $video_background, data_height, data_width, grid, height_ratio, margin_left, margin_top, video_height, video_width, width_ratio;
            $slide = $(element);
            ...
            if (_this.settings.content_scaling === true) {
              $('.rock-content-wrapper', _this.element).css({
                height: _this.parent_height / _this.scaling_value
              });
            }
...
//# sourceMappingURL=../../src/maps/rock-slider/layouts/fluid.js.map
