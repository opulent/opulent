...
(function() {
  (function($, window, document) {
    "use strict";
    $.fn.rockSlider.swipeFluidLayout = function() {
      this.init = function() {
        var _defaults;
        _defaults = {
          speed: 700,
        ...
        this.element.addClass('rock-slider-swipe-fluid');
      ...
      this.setup = function() {
        ...
        this.element.height(this.parent_height);
        this.element.width(this.parent_width);
        if (this.parent_height > this.element_height) {
          this.element_height = this.parent_height;
          this.element_width = this.element_height / this.settings.layout_settings.height * this.settings.layout_settings.width;
          this.inner.height(this.element_height);
          this.inner.width(this.parent_width * this.slides_length);
          this.wrapped_slides.height(this.element_height);
          this.wrapped_slides.width(this.parent_width);
        } else {
          this.element_width = this.parent_width;
          this.element_height = this.element_width / this.settings.layout_settings.width * this.settings.layout_settings.height;
          this.inner.height(this.element_height);
          this.inner.width(this.element_width * this.slides_length);
          this.wrapped_slides.height(this.parent_height);
        ...
        this.slides.each((function(_this) {
          return function(i, element) {
            var $background, $layers, $slide, $video, $video_background, data_height, data_width, height_ratio, margin_left, margin_top, video_height, video_width, width_ratio;
            $slide = $(element);
            ...
            margin_left = -(_this.visible_width - _this.parent_width) / 2;
            margin_top = -(_this.visible_height - _this.parent_height) / 2;
    ...
    $.rockSlider.add_layout('swipe-fluid', $.fn.rockSlider.swipeFluidLayout);
  })(jQuery, window, document);

}).call(this);

//# sourceMappingURL=../../src/maps/rock-slider/layouts/swipe-fluid.js.map
