...
(($, window, document) ->
  ...
  $.fn.rockSlider.contentLayout = ->
    # Initialize the @parameters
    #
    @init = ->
      # Add Classes
      @element.addClass 'rock-slider-content'
      ...
      $(window).resize =>
        content_height = $('.rock-content', @active).outerHeight(true)
    ...
    @slide = (i, prev) ->
      ...
      content_height = $('.rock-content-container', @active).height()
  ...
  # Add the layout to RockSlider as a new instance
  #
